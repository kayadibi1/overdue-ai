...
export const COMMITMENTS: Commitment[] = [
  ...
  { id: 'anthropic-rsp-v1', lab: 'Anthropic',
  ...
  { id: 'anthropic-eval-cadence', lab: 'Anthropic',
  ...
  { id: 'anthropic-ltbt-majority', lab: 'Anthropic',
  ...
  { id: 'openai-preparedness-annual-review', lab: 'OpenAI',
  ...
  { id: 'deepmind-fsf-early-2025', lab: 'Google DeepMind',
  ...
  { id: 'deepmind-fsf-eval-cadence', lab: 'Google DeepMind',
  ...
  { id: 'wh-voluntary-redteam-2023', lab: 'Multi-lab',
  ...
  { id: 'nist-aisi-mou-2024', lab: 'Multi-lab',
  ...
  { id: 'uk-aisi-predeployment', lab: 'Multi-lab',
  ...
  { id: 'eu-gpai-cop-finalized', lab: 'Multi-lab',
  ...
  { id: 'eu-aia-gpai-apply-2025', lab: 'Multi-lab',
  ...
  { id: 'anthropic-rsp-v3', lab: 'Anthropic',
  ...
  { id: 'anthropic-sabotage-reports', lab: 'Anthropic',
  ...
  { id: 'anthropic-risk-report-next', lab: 'Anthropic',
  ...
  { id: 'anthropic-annual-procedural-review', lab: 'Anthropic',
  ...
  { id: 'eu-aia-highrisk-annex3-2026', lab: 'Multi-lab',
  ...
  { id: 'eu-aia-highrisk-annex1-2027', lab: 'Multi-lab',
  ...
  { id: 'eu-aia-commission-eval-2028', lab: 'Multi-lab',
